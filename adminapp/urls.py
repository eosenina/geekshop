...
from adminapp.views import admin_categories_read, admin_categories_create, admin_categories_update, \
    admin_categories_remove
from adminapp.views import admin_products_read, admin_products_create, admin_products_update, admin_products_remove
